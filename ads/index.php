...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("RESOURCES","PRICE","FLOORS","AREA","BATHROOMS","GARAGE","DEAL","GALLERY","MATERIALS","",""),
		...
		"LIST_PROPERTY_CODE" => array("PRICE","FLOORS","AREA","BATHROOMS","GARAGE",""),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "6",
